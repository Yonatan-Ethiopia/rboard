...
---
**1. Download the latest `rboard-linux-x64.tar.gz` from the [release](https://github.com/Yonatan-Ethiopia/rboard/releases/download/v0.1.1/rboard-linux-x64.tar.gz) page.**
